...
# INTRODUCTION
This is an exmple project for packaging my own python project. This assumes you to use `uv`.
...
1. Create `docs` directory: `uv run sphinx-quickstart docs`
...
```
4. Generate `rst` files: `uv run sphinx-apidoc -f -o ./docs/source ../`
